...
set_target_properties(clangAnalysisLifetimeSafety PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libclangAnalysisLifetimeSafety.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS clangAnalysisLifetimeSafety )
list(APPEND _IMPORT_CHECK_FILES_FOR_clangAnalysisLifetimeSafety "${_IMPORT_PREFIX}/lib/libclangAnalysisLifetimeSafety.a" )

# Import target "clangAnalysisScalable" for configuration "Release"
set_property(TARGET clangAnalysisScalable APPEND PROPERTY IMPORTED_CONFIGURATIONS RELEASE)
set_target_properties(clangAnalysisScalable PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libclangAnalysisScalable.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS clangAnalysisScalable )
list(APPEND _IMPORT_CHECK_FILES_FOR_clangAnalysisScalable "${_IMPORT_PREFIX}/lib/libclangAnalysisScalable.a" )
...
set_target_properties(clangOptions PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libclangOptions.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS clangOptions )
list(APPEND _IMPORT_CHECK_FILES_FOR_clangOptions "${_IMPORT_PREFIX}/lib/libclangOptions.a" )
...
set_target_properties(clang PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/clang-23"
  )

list(APPEND _IMPORT_CHECK_TARGETS clang )
list(APPEND _IMPORT_CHECK_FILES_FOR_clang "${_IMPORT_PREFIX}/bin/clang-23" )
...
list(APPEND _IMPORT_CHECK_FILES_FOR_clang-nvlink-wrapper "${_IMPORT_PREFIX}/bin/clang-nvlink-wrapper" )
...
list(APPEND _IMPORT_CHECK_TARGETS clang-sycl-linker )
list(APPEND _IMPORT_CHECK_FILES_FOR_clang-sycl-linker "${_IMPORT_PREFIX}/bin/clang-sycl-linker" )
...
set_target_properties(clang-cpp PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libclang-cpp.so.23.0git"
  IMPORTED_SONAME_RELEASE "libclang-cpp.so.23.0git"
  )

list(APPEND _IMPORT_CHECK_TARGETS clang-cpp )
list(APPEND _IMPORT_CHECK_FILES_FOR_clang-cpp "${_IMPORT_PREFIX}/lib/libclang-cpp.so.23.0git" )
...
set_target_properties(libclang PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libclang.so.23.0.0git"
  IMPORTED_SONAME_RELEASE "libclang.so.23.0git"
  )

list(APPEND _IMPORT_CHECK_TARGETS libclang )
list(APPEND _IMPORT_CHECK_FILES_FOR_libclang "${_IMPORT_PREFIX}/lib/libclang.so.23.0.0git" )
...
list(APPEND _IMPORT_CHECK_TARGETS offload-arch )
list(APPEND _IMPORT_CHECK_FILES_FOR_offload-arch "${_IMPORT_PREFIX}/bin/offload-arch" )
