...
OUTPUT_ARCH(aarch64)
ENTRY(_start)
SEARCH_DIR("/__w/clang-builder/clang-builder/clang-main/install/aarch64-linux-gnu/lib64"); SEARCH_DIR("/__w/clang-builder/clang-builder/clang-main/install/aarch64-linux-gnu/lib");
SECTIONS
{
