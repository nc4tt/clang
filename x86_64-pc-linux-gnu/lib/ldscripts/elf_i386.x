...
OUTPUT_ARCH(i386)
ENTRY(_start)
SEARCH_DIR("/__w/clang-builder/clang-builder/clang-main/install/i386-pc-linux-gnu/lib32"); SEARCH_DIR("/__w/clang-builder/clang-builder/clang-main/install/x86_64-pc-linux-gnu/lib32"); SEARCH_DIR("/__w/clang-builder/clang-builder/clang-main/install/lib32"); SEARCH_DIR("/usr/local/lib32"); SEARCH_DIR("/lib32"); SEARCH_DIR("/usr/lib32"); SEARCH_DIR("/__w/clang-builder/clang-builder/clang-main/install/i386-pc-linux-gnu/lib"); SEARCH_DIR("/__w/clang-builder/clang-builder/clang-main/install/lib"); SEARCH_DIR("/usr/local/lib"); SEARCH_DIR("/lib"); SEARCH_DIR("/usr/lib");
SECTIONS
{
