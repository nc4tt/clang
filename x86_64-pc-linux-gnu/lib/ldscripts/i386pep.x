...
SEARCH_DIR("/__w/clang-builder/clang-builder/clang-main/install/x86_64-pep/lib"); SEARCH_DIR("/__w/clang-builder/clang-builder/clang-main/install/lib"); SEARCH_DIR("/usr/local/lib"); SEARCH_DIR("/lib"); SEARCH_DIR("/usr/lib");
SECTIONS
{
